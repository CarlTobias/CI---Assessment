...
const garages = [
  ...
  // Abu Dhabi Garages
  {
    ...
    services: [
      "Battery, brakes, air conditioning, and electrical repairs",
      "Oil change",
  ...
  },
  {
    ...
    services: [
      "Engine repair, wheel alignment, body trim, and transmission services",
      "Car waxing, air conditioning, and diagnostic services",
      "Fleet maintenance and ceramic coating paint protection",
    ],
  ...
  },
  {
    ...
    services: [
      ...
      "Car detailing",
      "Car waxing",
      "Battery replacement and oil change",
      "Computer diagnostics and full inspection",
    ],
  ...
  },
  {
    ...
    services: [
      ...
      "Denting and Painting",
      "Vehicle Detailing and Polishing",
      "Accident Repairs",
